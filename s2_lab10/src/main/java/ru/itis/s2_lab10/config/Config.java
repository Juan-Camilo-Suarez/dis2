package ru.itis.s2_lab10.config;
...
@EnableJpaRepositories("ru.itis.s2_lab10.repositories")
...
public class Config implements WebMvcConfigurer {
    ...
    public DataSource getDataSource() {
        ...
        dataSource.setPassword("Jcss2002");
        return dataSource;
    }
    @Bean
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        jpaProperties.setProperty("hibernate.hbm2ddl.auto", "create"); // none, update
        jpaProperties.setProperty("hibernate.show_sql", "true"); // ddl-auto
        em.setJpaProperties(jpaProperties);
        em.setPersistenceUnitName("lab10");
        em.setPackagesToScan("ru.itis.s2_lab10.model");
